...
import Settings from './components/Settings.js?v=0.9.76';
import CharacterSheet from './components/CharacterSheet.js?v=0.9.76';
import CreateWizard from './components/CreateWizard.js';
import { AdventureTab } from './components/AdventureTab.js';
import { AuthService } from './services/AuthService.js?v=0.9.76';
import { CampaignDetail } from './components/CampaignDetail.js?v=0.9.76';
import { Dice } from './dice.js?v=0.9.76';
import { Storage } from './storage.js?v=0.9.76';
import { CampaignService } from './services/CampaignService.js?v=0.9.76';
        ...
        try {
            ...
            if ('serviceWorker' in navigator) {
                try {
                    ...
                    // Auto-detect update (Silent)
                    registration.addEventListener('updatefound', () => {
                        const newWorker = registration.installing;
                        console.log('New worker installing...');
                        newWorker.addEventListener('statechange', () => {
                            if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                                console.log('New version installed in background.');
                            }
                        });
                    });
                } catch (err) {
