...
import Settings from './components/Settings.js?v=0.9.49';
import CharacterSheet from './components/CharacterSheet.js?v=0.9.49';
import CreateWizard from './components/CreateWizard.js';
import { AdventureTab } from './components/AdventureTab.js';
import { AuthService } from './services/AuthService.js?v=0.9.49';
import { CampaignDetail } from './components/CampaignDetail.js?v=0.9.49';
import { Dice } from './dice.js?v=0.9.49';
import { Storage } from './storage.js?v=0.9.49';
import { CampaignService } from './services/CampaignService.js?v=0.9.49';
