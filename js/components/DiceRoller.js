...
export default class DiceRoller {
    ...
    async render() {
        ...
        div.innerHTML = `
            ...
            <div class="fixed-dice-bg" style="position: fixed; bottom: -40px; left: 50%; transform: translateX(-50%); width: 100%; max-width: 500px; z-index: 0; pointer-events: none; opacity: 0.6; mask-image: linear-gradient(to top, black 80%, transparent 100%); -webkit-mask-image: linear-gradient(to top, black 80%, transparent 100%);">
